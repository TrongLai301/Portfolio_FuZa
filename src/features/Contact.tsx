...
const Contact = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    ...
    >
      <div
        className="w-[90%] md:max-w-6xl mx-auto flex flex-col items-center"
        ref={containerRef}
      >
        {/* Title */}
        <div
          className="animation opacity-0 text-center mb-10 md:mb-24 relative z-10 w-full"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-4 lg:gap-12 w-full mt-8">
          ...
          <ContactCard
            type="message"
            title="Discord Group"
            description="Join our community space! Feel free to hop in and hang out with everyone in our official server."
            buttonText="Join now"
            buttonLink="https://discord.gg/xU2UYY6BBW"
            icon={faDiscord}
          />
        </div>
      </div>
